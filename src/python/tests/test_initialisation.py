...
def print_parameter_set(my_chemistry):
    parameters = ["CaseBRecombination", "useSavin2004", "three_body_rate", "useOmukai2000", "crg_coolExi",\
                    "crg_collIon", "crg_recomCool", "crg_bremCool",\
                    "useLique2015", "photoelectric_heating"]
...
def test_rate_initialisation(printParameters=False, printOOMdiscrepanices=False):
    ...
    testRates = "k1,k3,k4,k2,k5,k6,k7,k8,k9,k10,k11,k12,k14,k15,k16,k17,k18,k19,k20,k23,"\
        ...
        "gamma_isrf,k24,k25,k26,k27,k28,k29,k30,k31".split(',')
