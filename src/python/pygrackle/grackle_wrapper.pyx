...
def solve_chemistry(fc, my_dt):
    ...
    my_fields.He_gas_metalDensity = get_field(fc, "He_gasDensity")
    my_fields.C_gas_metalDensity = get_field(fc, "C_gasDensity")
    my_fields.N_gas_metalDensity = get_field(fc, "N_gasDensity")
    my_fields.O_gas_metalDensity = get_field(fc, "O_gasDensity")
    my_fields.Ne_gas_metalDensity = get_field(fc, "Ne_gasDensity")
    my_fields.Mg_gas_metalDensity = get_field(fc, "Mg_gasDensity")
    my_fields.Si_gas_metalDensity = get_field(fc, "Si_gasDensity")
    my_fields.S_gas_metalDensity = get_field(fc, "S_gasDensity")
    my_fields.Ca_gas_metalDensity = get_field(fc, "Ca_gasDensity")
    my_fields.Fe_gas_metalDensity = get_field(fc, "Fe_gasDensity")
    my_fields.He_dust_metalDensity = get_field(fc, "He_dustDensity")
    my_fields.C_dust_metalDensity = get_field(fc, "C_dustDensity")
    my_fields.N_dust_metalDensity = get_field(fc, "N_dustDensity")
    my_fields.O_dust_metalDensity = get_field(fc, "O_dustDensity")
    my_fields.Ne_dust_metalDensity = get_field(fc, "Ne_dustDensity")
    my_fields.Mg_dust_metalDensity = get_field(fc, "Mg_dustDensity")
    my_fields.Si_dust_metalDensity = get_field(fc, "Si_dustDensity")
    my_fields.S_dust_metalDensity = get_field(fc, "S_dustDensity")
    my_fields.Ca_dust_metalDensity = get_field(fc, "Ca_dustDensity")
    my_fields.Fe_dust_metalDensity = get_field(fc, "Fe_dustDensity")
    my_fields.SNe_ThisTimeStep = get_field(fc, "SNe_thisTimestep")
